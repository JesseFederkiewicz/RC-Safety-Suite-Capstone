...
void Main()
{
	...
	/*		mcpwm_set_duty(m1.pwm.unit, m1.pwm.timer, m1.pwm.opOut, atoi(jason["xCoord"]));
			mcpwm_set_duty(m2.pwm.unit, m2.pwm.timer, m2.pwm.opOut, atoi(jason["yCoord"]));*/
			mcpwm_set_duty(m1.pwm.unit, m1.pwm.timer, m1.pwm.opOut, xCoord);
			mcpwm_set_duty(m2.pwm.unit, m2.pwm.timer, m2.pwm.opOut, yCoord);
