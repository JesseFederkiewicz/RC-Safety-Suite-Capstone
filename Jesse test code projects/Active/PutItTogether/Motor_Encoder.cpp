...
void MotorAndEncoderInits()
{
	...
	frontLeftMotor.pwm.unit = MCPWM_UNIT_0;
	frontLeftMotor.pwm.unit = MCPWM_UNIT_0;   // Front Left using pwm unit 0
	frontLeftMotor.pwm.timer = MCPWM_TIMER_0; // Front Left using unit 0 timer 0
	frontLeftMotor.pwm.opOut = MCPWM_OPR_A;   // Front Left on operator 0 output A
	frontLeftMotor.pwm.signal = MCPWM0A;      // sort of the same as above, needed for gpio_init
	frontLeftMotor.pwm.pin = 22;
	...
	frontRightMotor.pwm.unit = frontLeftMotor.pwm.unit;   // Front Right shares unit with FL_PWM
	frontRightMotor.pwm.timer = frontLeftMotor.pwm.timer; // Front Right shares timer with FL_PWM
	frontRightMotor.pwm.opOut = MCPWM_OPR_B;  // Front Right on operator 0 output B
	frontRightMotor.pwm.signal = MCPWM0B;     // needed for gpio_init
	frontRightMotor.pwm.pin = 23;		     // pwm for Front Right on pin 23
	...
	backLeftMotor.pwm.unit = MCPWM_UNIT_1;   // Back Left using pwm unit 1
	backLeftMotor.pwm.timer = MCPWM_TIMER_0; // Back Left using unit 1 timer 0
	backLeftMotor.pwm.opOut = MCPWM_OPR_A;   // Back Left on operator 0 output A
	backLeftMotor.pwm.signal = MCPWM0A;      // needed for gpio_init
	backLeftMotor.pwm.pin = 17;		      // pwm for Back Left on pin 17
	...
	backRightMotor.pwm.unit = backLeftMotor.pwm.unit;   // Back Right shares unit with Back Left
	backRightMotor.pwm.timer = backLeftMotor.pwm.timer; // Back Right shares timer with Back Left
	backRightMotor.pwm.opOut = MCPWM_OPR_B;  // Back Right on operator 0 output B
	backRightMotor.pwm.signal = MCPWM0B;     // needed for gpio_init
	backRightMotor.pwm.pin = 2;			     // pwm for Back Right on pin 2
...
{
	mcpwm_set_duty(frontLeftMotor.pwm.unit, frontLeftMotor.pwm.timer, frontLeftMotor.pwm.opOut, duties.FL_Duty);
	mcpwm_set_duty(frontRightMotor.pwm.unit, frontRightMotor.pwm.timer, frontRightMotor.pwm.opOut, duties.FR_Duty);
	mcpwm_set_duty(backLeftMotor.pwm.unit, backLeftMotor.pwm.timer, backLeftMotor.pwm.opOut, duties.BL_Duty);
	mcpwm_set_duty(backRightMotor.pwm.unit, backRightMotor.pwm.timer, backRightMotor.pwm.opOut, duties.BR_Duty);
