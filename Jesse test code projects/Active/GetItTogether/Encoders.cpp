...
RPMS GetRPMS()
{
	...
	Serial.println(fl_Enc2);
	Serial.println(bl_Enc);
	Serial.println(bl_Enc2);
	Serial.println(fr_Enc);
	Serial.println(fr_Enc2);
	Serial.println(br_Enc);
	Serial.println(br_Enc2);
...
typedef struct DirectionCounters {
	int Bl;
	int Br;
	int Fr;
	int Fl;
...
DirectionCounters stopCounts = { 0,0,0,0 };
DirectionCounters forwardCounts = { 0,0,0,0 };
DirectionCounters backwardCounts = { 0,0,0,0 };

void GetDirections(RPMS* rpm)
{
	EncoderReadings encoders;
	const int stopHere = 2;

	//pcnt_get_counter_value(PCNT_UNIT_0, &encoders.FL_Encoder1);
	//pcnt_get_counter_value(PCNT_UNIT_4, &encoders.FL_Encoder2);
	//pcnt_get_counter_value(PCNT_UNIT_1, &encoders.FR_Encoder1);
	//pcnt_get_counter_value(PCNT_UNIT_5, &encoders.FR_Encoder2);
	//pcnt_get_counter_value(PCNT_UNIT_2, &encoders.BL_Encoder1);
	//pcnt_get_counter_value(PCNT_UNIT_6, &encoders.BL_Encoder2);
	//pcnt_get_counter_value(PCNT_UNIT_3, &encoders.BR_Encoder1);
	//pcnt_get_counter_value(PCNT_UNIT_7, &encoders.BR_Encoder2);

	//Serial.println();
	//Serial.println(encoders.FL_Encoder1);
	//Serial.println(encoders.FL_Encoder2);
	//Serial.println(encoders.FR_Encoder1);
	//Serial.println(encoders.FR_Encoder2);
	//Serial.println(encoders.BL_Encoder1);
	//Serial.println(encoders.BL_Encoder2);
	//Serial.println(encoders.BR_Encoder1);
	//Serial.println(encoders.BR_Encoder2);

	//Serial.println();

	////BL
	//int BlVal = encoders.BL_Encoder1 - encoders.BL_Encoder2;
	...
	//	forwardCounts.Bl = 0;
	//}
	//if (forwardCounts.Bl >= stopHere) {
	//	rpm->BL_Wheel_movement = forward;
	//	Serial.println("BL forward");
	//}

	//else if (backwardCounts.Bl >= stopHere) {
	//	rpm->BL_Wheel_movement = backward;
	//	Serial.println("BL backward");
	//}

	//else if (stopCounts.Bl >= stopHere) {
	//	rpm->BL_Wheel_movement = stopped;
	//	Serial.println("BL stopped");
	//}

	////FL
	//if (encoders.FL_Encoder1 - encoders.FL_Encoder2 > 0) {
	//	stopCounts.Fl = 0;
	//	backwardCounts.Fl = 0;
	//	forwardCounts.Fl++;
	//}
	//else if (encoders.FL_Encoder1 - encoders.FL_Encoder2 < 0) {
	//	stopCounts.Fl = 0;
	//	forwardCounts.Fl = 0;
	//	backwardCounts.Fl++;
	//}
	...
	//if (forwardCounts.Fl >= stopHere) {
	//	rpm->FL_Wheel_movement = forward;
	//	Serial.println("FL forward");
	//}

	//else if (backwardCounts.Fl >= stopHere) {
	//	rpm->FL_Wheel_movement = backward;
	//	Serial.println("FL backward");
	//}

	//if (stopCounts.Fl >= stopHere) {
	//	rpm->FL_Wheel_movement = stopped;
	//	Serial.println("FL stopped");
	//}

	////BR
	//if (encoders.BR_Encoder1 - encoders.BR_Encoder2 > 0) {
	//	stopCounts.Br = 0;
	//	forwardCounts.Br = 0;
	//	backwardCounts.Br++;
	//}
	//else if (encoders.BR_Encoder1 - encoders.BR_Encoder2 < 0) {
	//	stopCounts.Br = 0;
	//	forwardCounts.Br++;
	//	backwardCounts.Br = 0;
	//}
	...
	//if (forwardCounts.Br >= stopHere) {
	//	rpm->BR_Wheel_movement = forward;
	//	Serial.println("BR forward");
	//}

	//else if (backwardCounts.Br >= stopHere) {
	//	rpm->BR_Wheel_movement = backward;
	//	Serial.println("BR backward");
	//}

	//if (stopCounts.Br >= stopHere) {
	//	rpm->BR_Wheel_movement = stopped;
	//	Serial.println("BR stopped");
	//}

	////FR
	//if (encoders.FR_Encoder1 - encoders.FR_Encoder2 > 0) {
	//	stopCounts.Fr = 0;
	//	forwardCounts.Fr = 0;
	//	backwardCounts.Fr++;
	//}
	//else if (encoders.FR_Encoder1 - encoders.FR_Encoder2 < 0) {
	//	stopCounts.Fr = 0;
	//	forwardCounts.Fr++;
	//	backwardCounts.Fr = 0;
	//}
	...
	//if (forwardCounts.Fr >= stopHere) {
	//	rpm->FR_Wheel_movement = forward;
	//	Serial.println("FR forward");
	//}

	//else if (backwardCounts.Fr >= stopHere) {
	//	rpm->FR_Wheel_movement = backward;
	//	Serial.println("FR backward");
	//}

	//if (stopCounts.Fr >= stopHere) {
	//	rpm->FR_Wheel_movement = stopped;
